...
- CMake 4.4.3, Ninja 1.13.2, jsonschema 4.26.0, PyYAML 6.0.2 and dependencies: versions in requirements.txt; license notices in each `.dist-info` directory and CMake share directory.
