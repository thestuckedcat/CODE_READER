...
The current 0.8 architecture establishes enforceable boundaries for new work while
...
| Application | `atlas.application.service` | `pipeline`, `graph`, `dataflow`, `concurrency`, `aliasing`, `virtual_dispatch`, `review` |
