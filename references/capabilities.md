...
| Lock and shared-state analysis | Implemented for Clang-resolved common lock APIs, lexical regions, simple acquire/release wrapper projection, static/global accesses and conservative conflict pairs |
| Field alias and callback candidates | Implemented for bounded address/copy/argument propagation, conservative multi-target object sets, nested member paths, same-function callback set/clear states, lock ownership summaries and simple lock-wrapper projection in tested fixtures |
