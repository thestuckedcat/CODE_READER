...
def stage_contracts() -> Tuple[Stage, ...]:
    ...
    return (
        ...
        Stage("alias", ("compiler facts", "call graph", "lock analysis"), ("alias_analysis.json", "field_accesses.jsonl", "lock_ownership_summaries.jsonl", "callback_targets.jsonl"), "alias_and_lock_ownership_ready_or_partial"),
